...
class TaskState:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TaskState":
        return cls(
            ...
            success_criteria=data.get("success_criteria", data.get("success", {"must_have": []})),
...
def create_default_state(
    ...
    must_have_fields: Optional[List[str]] = None,
) -> TaskState:
    if plan is None:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TaskState":
        return cls(
            ...
            success_criteria=data.get(
                "success_criteria", data.get("success", {"must_have": []})
            ),
            query_type=data.get("query_type", "factoid"),
            completion=data.get("completion", 0.0),
            attempt_count=data.get("attempt_count", 0),
